...
public class HealthRecordServiceImpl implements HealthRecordService {
	...
	@Transactional
	@Override
	public void gainOrLossCalorieDeficit(Integer userId, Integer calorie) {
		HealthRecord healthRecord = findLastDateByUserId(userId);
		healthRecord.setCalorieDeficit(healthRecord.getCalorieDeficit()+calorie);
		healthRecordRepo.save(healthRecord);
	}
